...
export default function StackedCards(){
    ...
    const cards = document.querySelectorAll(".trump-cards");
const spotlight = document.querySelector(".spotlight")
const cardsContainer = document.querySelector(".trump")
 ...
 gsap.ticker.add(()=>{
        ...
        return(
            ...
            <section className="spotlight">
                    <div className="trump" >
                        <div className="trump-cards" ><img src="/cardimage-1.jpg" alt="first-image" /></div>
                        <div className="trump-cards" ><img src="/cardimage-2.jpg" alt="second-image"/></div>
                        <div className="trump-cards" ><img src="/cardimage-3.jpg" alt="third-image" /></div>
                        <div className="trump-cards" ><img src="/cardimage-4.jpg" alt="fourth-image" /></div>
                    </div>
